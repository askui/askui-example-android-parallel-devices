...
./askui-ui-controller.exe -d 1 -m -r android -p 6770 
```
...
Each worker is selecting one android devices based on theire `JEST_WORKER_ID`. See line 16 - 31 in `askui_example/helpers/askui-helper.ts`
